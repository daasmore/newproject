...
exports.InvitationsModule = InvitationsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([invitation_entity_1.Invitation, message_entity_1.Message])],
        controllers: [invitations_controller_1.InvitationsController],
        providers: [invitations_service_1.InvitationsService, invitation_owner_guard_1.InvitationOwnerGuard],
        exports: [invitations_service_1.InvitationsService, invitation_owner_guard_1.InvitationOwnerGuard],
    })
], InvitationsModule);
